...
SOFT_VIOLATION_WEIGHTS: dict[str, int] = {
    "online_f2f_switch_staff": 8,
    "online_f2f_switch_group": 8,
    "tutor_idle_gap_long": 6,
    "tutor_idle_gap_short": 2,
    "group_consecutive_hours": 7,
    "group_back_to_back_hours": 5,
    "room_utilisation": 3,
    "first_slot": 2,
    "last_slot": 2,
    "ends_after_17": 4,
